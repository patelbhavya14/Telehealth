...
//        dB4OUtil.storeSystem(system);
    ...
    private void jmiNetworkActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
        JPanel currentPanel = new JPanel(new BorderLayout());
        ...
        mainPanel.add(containerPanel, "Network Panel");
...
//        titlePanel.setBounds((int) dim.getWidth(), (int) dim.getHeight(), 1200, 50);
    ...
    private void jmiOrganizationActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
        ...
        mainPanel.add(containerPanel, "Enterprise Panel");
        CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
        cardLayout.next(mainPanel);
...
//        mainPanel.revalidate();
    ...
    private void jmiPatientActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
        JPanel currentPanel = new JPanel(new BorderLayout());
        ...
        mainPanel.add(containerPanel, "Patient Panel");
        CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
        cardLayout.next(mainPanel);
//        mainPanel.add(titlePanel);
//        mainPanel.add(currentPanel);
...
//        mainPanel.revalidate();
    ...
    private void jmiUserAccountActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
        JPanel currentPanel = new JPanel(new BorderLayout());
...
//        currentPanel = enterpriseAdminPanel;
        ...
        mainPanel.add(containerPanel, "User Panel");
        CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
        cardLayout.next(mainPanel);
//        mainPanel.add(titlePanel);
//        mainPanel.add(currentPanel);
...
//        mainPanel.revalidate();
    ...
    private void jmiAddUserActionPerformed(java.awt.event.ActionEvent evt) {                                           
        // TODO add your handling code here:
        JPanel currentPanel = new JPanel(new BorderLayout());
...
//        currentPanel = enterpriseAdminPanel;
        ...
        mainPanel.add(containerPanel, "Add User Panel");
        CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
        cardLayout.next(mainPanel);
//        mainPanel.add(titlePanel);
//        mainPanel.add(currentPanel);
...
//        mainPanel.revalidate();
    ...
    private void jmiPatientDiagnosisActionPerformed(java.awt.event.ActionEvent evt) {                                                    
        // TODO add your handling code here:
...
//        System.out.println("Role: "+new HospitalRole());
        if (userAccount.getRole().toString().equals(new HospitalRole().toString())) {
            ...
            mainPanel.add(containerPanel, "Patient Diagnosis");
            CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
            cardLayout.next(mainPanel);
//            mainPanel.add(titlePanel);
//            mainPanel.add(currentPanel);
...
//            mainPanel.revalidate();
    ...
    private void jmiPatientPrescriptionActionPerformed(java.awt.event.ActionEvent evt) {                                                       
        // TODO add your handling code here:
//        if(userAccount.getRole().toString().equals(new HospitalRole().toString())){
        JPanel currentPanel = new JPanel(new BorderLayout());
...
//        }
    ...
    private void jmiAddInsuranceActionPerformed(java.awt.event.ActionEvent evt) {                                                
        // TODO add your handling code here:
        JPanel currentPanel = new JPanel(new BorderLayout());
        ...
        mainPanel.add(containerPanel, "Add Insurance");
        CardLayout cardLayout = (CardLayout) mainPanel.getLayout();
        cardLayout.next(mainPanel);
//        mainPanel.add(titlePanel);
//        mainPanel.add(currentPanel);
